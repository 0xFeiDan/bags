...
class AccountDataSource(Base):
    ...
    requests_per_second_limit: Mapped[int] = mapped_column(Integer, default=1)
    daily_request_limit: Mapped[int] = mapped_column(Integer, default=300)
    ...
    daily_request_budget: Mapped[int] = mapped_column(Integer, default=270)
